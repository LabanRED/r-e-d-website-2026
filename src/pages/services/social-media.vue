<template>
  <div class="w-full bg-[#f8f9fa] min-h-screen relative font-sans overflow-x-hidden pt-8 sm:pt-16 pb-20 md:pb-0 lg:pb-0">
    ...
    <section class="mx-auto lg:w-[95%] max-w-[1600px] px-6 sm:px-8 lg:px-0 py-12 lg:py-24">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">

        <!-- Left Column: Phone Mockup -->
        <div class="w-full flex justify-center lg:justify-end pr-0 lg:pr-10 relative">
          <img
            :src="phoneMockup"
        ...
        <div class="flex flex-col items-start text-left lg:pl-10">
          ...
          <div class="flex flex-wrap gap-8 sm:gap-12 lg:gap-16">
            <div v-for="(_, i) in 4" :key="i" class="flex flex-col items-center gap-4">
              <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-[#e5e5e5]"></div>
              <span class="font-poppins text-[11px] font-medium tracking-widest text-neutral-600 uppercase">
                Awareness
              </span>
            </div>
          </div>
