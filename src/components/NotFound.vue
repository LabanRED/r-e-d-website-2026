    ...
    <div class="relative mt-56 md:mt-0 lg:mt-0  z-10 max-w-xl w-full flex flex-col items-center">
      ...
      <form @submit.prevent="handleSearchSubmit" class="w-full max-w-md mb-4 relative z-30">
        <div class="flex flex-col sm:flex-row items-center gap-2.5 w-full">
          ...
          <button 
            type="submit" 
            class="w-full sm:w-auto px-6 py-2.5 rounded-full bg-black hover:bg-[#1ca3c4] hover:scale-105 active:bg-neutral-900 text-sm font-medium text-white shadow-sm transition-all duration-300 cursor-pointer shrink-0"
          >
            Search
          </button>
        </div>
      ...
      <div class="flex flex-col md:flex-row lg:flex-row items-center justify-center gap-3.5 w-full mt-4">
        ...
        <button
          @click="takeMeHome"
          type="button"
          class="inline-flex items-center justify-center px-6 py-2.5 w-full md:w-auto lg:w-auto rounded-full bg-black hover:bg-[#1ca3c4] hover:scale-105 active:bg-neutral-800 text-white text-sm font-medium transition-all duration-300 cursor-pointer"
        >
