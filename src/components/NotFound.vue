<template>
  <div class="relative min-h-[80vh] pt-24 w-full bg-white flex flex-col items-center justify-center p-6 text-center select-none overflow-hidden font-poppins">
    ...
    <div class="relative mt-56 md:mt-0 lg:mt-0  z-10 max-w-xl w-full flex flex-col items-center">
      ...
      <!-- Main Heading -->
      <h1 class="text-4xl sm:text-5xl md:text-6xl font-semibold tracking-tight text-neutral-900 pb-4 font-sans">
        Page not found
      </h1>
      ...
      <form @submit.prevent="handleSearchSubmit" class="w-full max-w-md mb-4 relative z-30">
        <div class="flex flex-col sm:flex-row items-center gap-2.5 w-full">
          ...
          <button 
            type="submit" 
            class="w-full sm:w-auto px-6 py-2.5 rounded-full bg-black hover:bg-primary hover:scale-105 active:bg-neutral-900 font-medium text-white shadow-sm transition-all duration-300 cursor-pointer shrink-0 text-base"
          >
            Search
          </button>
        </div>
      ...
      <div class="flex flex-col md:flex-row lg:flex-row items-center justify-center gap-3.5 w-full mt-4">
        ...
        <button 
          @click="goBack" 
          type="button"
          class="inline-flex items-center justify-center gap-2 px-5 py-2.5 w-full md:w-auto lg:w-auto rounded-full bg-neutral-100 hover:bg-black active:bg-neutral-300 text-neutral-800 hover:text-white font-medium transition-colors cursor-pointer border border-neutral-200/50 text-base"
        >
        ...
        <button
          @click="takeMeHome"
          type="button"
          class="inline-flex items-center justify-center px-6 py-2.5 w-full md:w-auto lg:w-auto rounded-full bg-black hover:bg-primary hover:scale-105 active:bg-neutral-800 text-white font-medium transition-all duration-300 cursor-pointer text-base"
        >
